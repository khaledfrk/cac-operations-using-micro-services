...
export default function SingleAppoitmentCoord({appointment}) {
...
<div key={id} >
    <div className="d-flex operations-scheduled">
      ...
      <div className='buttons-contain'>
       {(statCoordinateur === false) && (statAnesthesiste === true) && (statAnesthesiste === true) ? (<Link to={`/coordinateur/operationav/${idOperation}`}  className="fill">Remplire le form</Link>):(null)}
